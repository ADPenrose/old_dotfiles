...
**WARNING: Requieres [Neovim](https://neovim.io) version >= 0.7**
...
Credits to Devaslife for the original dotfiles. Go follow him:
- [His Youtube](https://www.youtube.com/c/devaslife)
- [His Twitter](https://twitter.com/inkdrop_app)
- [His Blog](https://blog.inkdrop.app/)
- [Go try out Inkdrop - Markdown note-taking app](https://www.inkdrop.app/)
